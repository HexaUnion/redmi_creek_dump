...
BOARD_KERNEL_CMDLINE := video=vfb:640x400,bpp=32,memsize=3072000 mtdoops.fingerprint=creek:13/OS2.0.211.0.VBOMIXM:user swinfo.fingerprint=creek:13/OS2.0.211.0.VBOMIXM:user bootconfig
